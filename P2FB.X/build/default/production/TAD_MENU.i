...
static unsigned char timerByeBye;
    ...
    switch(state){
        ...
        case 1:
            if((aux = JOY_GetMove()) != 0){
                aux == 1 ? MENU_OptionUp() : MENU_OptionDown();
            }
            else if(KPAD_GetChar() == '#'){
                exitMenu();
                switch(option){
                    case 1:
                        MICRO_ListenAndSend();
        ...
        case 3:
            ...
            MQ_PutString("1. START RECORDING", printNext);
            printNext++;
            state++;
            break;
        case 4:
            if(!LCD_IsAvailable()) break;
            MQ_PutString("2. PLAY RECORDINGS", printNext);
        ...
        case 5:
            if(!LCD_IsAvailable()) break;
            MQ_PutString("3. MODIFY CURRENT TIME", printNext);
        ...
        case 6:
            if(!LCD_IsAvailable()) break;
            MQ_PutString("4. SHOW CURRENT TIME", printNext);
        ...
        case 7:
            if(!LCD_IsAvailable()) break;
            MQ_PutString("5. END COMMUNICATION", printNext);
