...
# 2 "<built-in>" 2
# 1 "TAD_MARQUESINA.c" 2
# 1 "./TAD_MARQUESINA.h" 1
...
# 5 "TAD_MARQUESINA.c" 2



static unsigned char state;
static unsigned char indexL1, indexL2;
static unsigned char sizeL1, sizeL2;
static unsigned char biggerSize;
static char *strL1, *strL2;
...
void MQ_PutString(char *s, unsigned char line){
    ...
    biggerSize = (sizeL1 > sizeL2) ? sizeL1 : sizeL2;
    indexL1 = indexL2 = 0;
    TI_ResetTics(timer);
    state = 2;
}
    ...
    switch(state){
        ...
        case 2:
            ...
            if(strL1 != ((void*)0)){
                ...
                LCD_GotoXY(0, 0);
                if(indexL1 <= sizeL1) LCD_PutString(strL1 + indexL1);
                indexL1++;
            }
            state++;
            break;
        case 3:
            if(!LCD_IsAvailable()) break;
            if(strL1 != ((void*)0) && sizeL1 - indexL1 < 16){
        ...
        case 4:
            ...
            if(strL2 != ((void*)0)){
                ...
                LCD_GotoXY(0, 1);
                if(indexL2 <= sizeL2) LCD_PutString(strL2 + indexL2);
                indexL2++;
            }
            state++;
            break;
        case 5:
            if(!LCD_IsAvailable()) break;
            if(strL2 != ((void*)0) && sizeL2 - indexL2 < 16){
