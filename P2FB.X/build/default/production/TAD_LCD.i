...
# 58 "TAD_LCD.c"
void Espera(unsigned char Timer, unsigned char ms);
...
void LCD_Motor(void){
    switch(state) {
        case 0:
            break;
        case 1:
            if (str[index] != '\0') LCD_PutChar(str[index++]);
            else state--;
            break;
    }
}
...
void CantaPartAlta(char c) {
  (LATDbits.LATD7 = (c & 0x80 ? 1 : 0));
  (LATDbits.LATD6 = (c & 0x40 ? 1 : 0));
  (LATDbits.LATD5 = (c & 0x20 ? 1 : 0));
  (LATDbits.LATD4 = (c & 0x10 ? 1 : 0));
}

void CantaPartBaixa(char c) {
  (LATDbits.LATD7 = (c & 0x08 ? 1 : 0));
  (LATDbits.LATD6 = (c & 0x04 ? 1 : 0));
  (LATDbits.LATD5 = (c & 0x02 ? 1 : 0));
  (LATDbits.LATD4 = (c & 0x01 ? 1 : 0));
}
...
void WaitForBusy(void) { char Busy;
 ...
 TI_ResetTics(Timer);
 do {
  (LATDbits.LATD1 = 1);(LATDbits.LATD1 = 1);
  Busy = (PORTDbits.RD7);
  (LATDbits.LATD1 = 0);
  (LATDbits.LATD1 = 0);
  (LATDbits.LATD1 = 1);(LATDbits.LATD1 = 1);
...
void EscriuPrimeraOrdre(char ordre) {
 ...
 (TRISDbits.TRISD4 = TRISDbits.TRISD5 = TRISDbits.TRISD6 = TRISDbits.TRISD7 = 0); (LATDbits.LATD3 = 0); (LATDbits.LATD2 = 0);
 (LATDbits.LATD1 = 1); (LATDbits.LATD1 = 1);
  (LATDbits.LATD7 = (ordre & 0x08 ? 1 : 0));
  (LATDbits.LATD6 = (ordre & 0x04 ? 1 : 0));
  (LATDbits.LATD5 = (ordre & 0x02 ? 1 : 0));
  (LATDbits.LATD4 = (ordre & 0x01 ? 1 : 0));
 (LATDbits.LATD1 = 0);
}
