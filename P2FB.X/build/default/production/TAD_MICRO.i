...
static unsigned int sentSamples;
static unsigned char txTimer;
static unsigned char indexAux;
static unsigned char newID[2];
    ...
    switch(state){
        ...
        case 1:
            ...
            if(indexAux == 2){
                indexAux = 0;
                state++;
                SAVE_PutRecording(newID, CNT_GetTimeArr());
            }
            break;
        case 2:
        ...
        case 4:
            ...
            break;
        case 5:
            if(ADCON0bits.GO) break;
            ADCON0bits.ADON = 0;
            if(TI_GetTics(txTimer) < 1) break;
            SIO_PutChar(ADRESH);
            sentSamples++;
            if(sentSamples >= 32770){
                state = 0;
                BUZZ_PlayMelody();
                MENU_Mostrar();
                break;
