...
# 2 "TAD_SAVERECORDINGS.c" 2


static unsigned char state;
static unsigned char index;
static unsigned char recordingField;
...
void SAVE_Motor(void){
    ...
    switch(state){
        ...
        case 2:
            ...
            numRecordings = EEDATA;
            if(numRecordings > 10) numRecordings = 0;
            index = recordingField = 0;
            state++;
            break;
        case 3:
