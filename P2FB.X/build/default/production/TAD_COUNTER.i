...
static char time[4] = {0, 0, 0, 0};
static char timeAux[4] = {0, 0, 0, 0};
static char strAux[6];
unsigned static char timeAuxIndex;
unsigned static char timerHora;
unsigned static char modifyTime;
unsigned static char showTime;
...
void CNT_Motor(void) {
    ...
    switch (state) {
        ...
        case 5:
            state = 0;
            if((aux = KPAD_GetChar()) == 0xFF) break;
            if(aux == '*'){
                modifyTime = 0;
                LCD_CursorOff();
                KPAD_StopInput();
                ...
                timeAux[timeAuxIndex] = aux - '0';
                LCD_PutChar(aux);
                timeAuxIndex++;
                if(timeAuxIndex == 2) LCD_PutChar(':');
